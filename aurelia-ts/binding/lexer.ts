...
export class Scanner {
    ...
    scanString(): Token {
        ...
        while (this.peek !== quote) {
            if (this.peek === $BACKSLASH) {
                ...
                if (this.peek === $u) {
                    ...
                    unescaped = <number><any>decodeURIComponent(<any>this.peek);
                    this.advance();
                }

                buffer.push(String.fromCharCode(<number>unescaped));
                marker = this.index;
        ...
        return new Token(start, text).withValue(<string>unescaped);
    }
    ...
    error(message: string, offset: number = 0): void {
